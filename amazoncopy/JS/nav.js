class NavElements {
  constructor(positionVal) {
    ...
    this.navPosition = positionVal.navPosition;
    this.primBtnPosition = positionVal.primBtnPosition;
  }
...
const navElement = new NavElements({navPosition : 112, primBtnPosition : 465});
navElement.interaction();
